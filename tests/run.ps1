...
try {
    ...
    foreach ($name in @('test-app.ps1','test-review-regressions.ps1','test-viewports.ps1','test-empty-settings.ps1','test-reactions.ps1','test-cache.ps1','test-input.ps1','test-storage.ps1','test-startup.ps1')) {
