[CmdletBinding()]
param([ValidateRange(1,9)][int]$Repeats=3, [ValidateNotNullOrEmpty()][int[]]$Counts=@(1000,10000))
...
# The measurement succeeded and its CSV has been written to stdout. Keep failed runtimes for diagnosis.
